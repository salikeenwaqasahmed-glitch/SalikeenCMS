...
data class Salik(
    ...
    fun toMap(): Map<String, Any?> = mapOf(
        ...
        "bazamId" to bazamId,
        "khanqahId" to khanqahId,
        "salikCategoryId" to salikCategoryId,
    ...
    companion object {
        fun fromMap(map: Map<String, Any?>, id: String? = null): Salik {
            ...
            return Salik(
                ...
                khanqahId = (map["khanqahId"] as? String).orEmpty(),
                salikCategoryId = (map["salikCategoryId"] as? String).orEmpty(),
                dateOfBaith = (map["dateOfBaith"] as? String).orEmpty(),
                referenceName = (map["referenceName"] as? String).orEmpty(),
                referenceMobile = (map["referenceMobile"] as? String).orEmpty(),
                isNafiAsbat = bool("isNafiAsbat"),
                isSahibEMehfil = bool("isSahibEMehfil"),
                nafiZikrId = (map["nafiZikrId"] as? String).orEmpty(),
                profilePicture = (map["profilePicture"] as? String).orEmpty(),
                createdDate = (map["createdDate"] as? String).orEmpty(),
                modifiedDate = (map["modifiedDate"] as? String).orEmpty(),
                ...
                approvedAt = (map["approvedAt"] as? String).orEmpty(),
            )
        }
    }
}
